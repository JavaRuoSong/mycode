...
public class CustomerView {
	...
	private void addNewCustomer() {
		...
		Customer c1 = new Customer(name,gender , age, phone, email);
		boolean flag =  customers.addCustotmer(c1);
		if(flag) {
	...
	private void modifyCustomer() {
		...
		if(index ==-1){return;
		 ...
		 cust = customers.getCustomer(index) ;
		if(cust == null) {
...
//            System.out.println(i + 1 + "\t" + custs[i].getName() + "\t" + custs[i].getGender() + "\t" + custs[i].getAge() + "\t\t" + custs[i].getPhone() + "\t" + custs[i].getEmail());
            	System.out.println((i) + "\t" + custs[i].getDetails());
            }
        }
